  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto w-full relative z-10">
        <h2 className="text-xs md:text-sm uppercase tracking-[0.3em] text-brand-purple mb-8 md:mb-12 font-semibold">
          The Vision
        </h2>
        <h3 ref={textRef} className="text-[2rem] leading-[1.1] md:text-6xl lg:text-7xl font-bold md:leading-tight text-brand-light flex flex-wrap gap-x-3 gap-y-2 md:gap-x-4">
